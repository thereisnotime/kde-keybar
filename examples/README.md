...
Ready-to-use configs. Copy one to `~/.config/kde-keybar.json`, or point at it with
`kde-keybar -c examples/<name>.json`. Changes apply live, so you can also copy bits into
your own config.
